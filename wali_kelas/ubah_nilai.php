...
$nilai = query_nilai("SELECT nilai.*, tahun_ajaran2.*, kelas.*, mapel.*, user.*, guru.*  FROM nilai
                        ...
                        INNER JOIN guru ON guru.nip = nilai.nip WHERE id_nilai = $id_nilai") [0];
            ...
            <div id="content">
              ...
              <form action="" method="post">
                ...
                <div class="form-group">
                  <label>Nilai</label>
                  <input type="text" name="nilai" id="nilai" required="" value="<?= $nilai["nilai"]?>" class="form-control">
                </div>
