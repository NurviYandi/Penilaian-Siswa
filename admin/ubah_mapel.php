...
$mpl = query_mapel("SELECT * FROM mapel  WHERE id_mapel = $id_mapel") [0];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
              ...
              <form action="" method="post">
              	<input type="hidden" name="id_mapel" value="<?= $mpl["id_mapel"];  ?>">
                
                <div class="form-group">
                  <label>Nama Pelajaran</label>
                  <input type="text" name="nm_mapel" id="nm_mapel" required="" value="<?= $mpl["nm_mapel"]?>" class="form-control">
                </div>

                <div class="form-group">
                  <label>Kategori</label>
                  <input type="text" name="kategori" id="kategori" required="" value="<?= $mpl["kategori"]?>" class="form-control">
                </div>
