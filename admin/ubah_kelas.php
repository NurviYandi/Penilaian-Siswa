...
$kls = query_kelas("SELECT * FROM kelas WHERE id_kelas = $id_kelas") [0];
            ...
            <div id="content">
              ...
              <form action="" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nama_kelas" id="nama_kelas" required=""  value="<?= $kls["nama_kelas"];  ?>"  class="form-control">
                </div>
