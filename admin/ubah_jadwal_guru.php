...
$jg = query_jadwal_guru("SELECT jadwal_guru.*, guru.*, kelas.*, mapel.* FROM jadwal_guru
                        INNER JOIN guru ON guru.nip = jadwal_guru.nip
                        INNER JOIN kelas ON kelas.id_kelas = jadwal_guru.id_kelas
                        INNER JOIN mapel ON mapel.id_mapel = jadwal_guru.id_mapel WHERE id_jadwal_guru = $id_jadwal_guru") [0];

	if(isset($_POST["submit"]) ){

	// cek apakah data telah berhasil diubah atau tidak
	if(ubah_jadwal_guru($_POST) > 0){
		echo "
			 <script>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h4>FORM UBAH TAHUN AJARAN</h4>
                        </div>
                        <div class="card-body">
              <form action="" method="post">
              	<input type="hidden" name="id_jadwal_guru" value="<?= $jg["id_jadwal_guru"];  ?>">
                
                <div class="form-group">
                  <label>Hari</label>
                  <input type="text" name="hari" id="hari" required="" value="<?= $jg["hari"]?>" class="form-control">
                </div>

                <div class="form-group">
                  <label>Tanggal</label>
                  <input type="date" name="tanggal" id="tanggal" required="" value="<?= $jg["tanggal"]?>" class="form-control">
                </div>

                <div class="form-group">
                  <label>Jam Awal</label>
                  <input type="time" name="jam_awal" id="jam_awal" required="" value="<?= $jg["jam_awal"]?>" class="form-control">
                </div>

                <div class="form-group">
                  <label>Jam Akhir</label>
                  <input type="time" name="jam_akhir" id="jam_akhir" required="" value="<?= $jg["jam_akhir"]?>" class="form-control">
                </div>
