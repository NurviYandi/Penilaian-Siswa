            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                        ...
                        $siswa = mysqli_query($koneksi, "SELECT COUNT(nis) as total_siswa FROM `siswa`");
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Siswa</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_siswa['total_siswa'];?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fa fa-users fa-2x text-black-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        $guru = mysqli_query($koneksi, "SELECT COUNT(nip) as total_guru FROM `guru`");
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Guru</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_guru["total_guru"]; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fa fa-graduation-cap fa-2x text-black-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        $kelas = mysqli_query($koneksi, "SELECT COUNT(id_kelas) as total_kelas FROM `kelas`");
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Kelas</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_kelas["total_kelas"]; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fa fa-book fa-2x text-black-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
