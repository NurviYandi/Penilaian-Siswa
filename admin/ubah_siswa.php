...
$siswa = query_siswa("SELECT siswa.*, user.*, kelas.* FROM siswa 
                        JOIN user ON siswa.id_user = user.id_user 
                        JOIN kelas ON siswa.id_kelas = kelas.id_kelas WHERE siswa.id_user = $id_user") [0];
            ...
            <div id="content">
              ...
              <form action="" method="post">
                ...
                <div class="form-group">
                  <label>NIS</label>
                  <input type="text" name="nis" id="nis" required=""  value="<?= $siswa["nis"];  ?>"  class="form-control">
                </div>

                <div class="form-group">
                  <label>Nama Siswa</label>
                  <input type="text" name="nama_siswa" id="nama_siswa" required=""  value="<?= $siswa["nama_siswa"];  ?>" class="form-control">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="tanggal_lahir" id="tanggal_lahir" required=""  value="<?= $siswa["tanggal_lahir"];  ?>" class="form-control">
                </div>

                <div class="form-group">
                  <label>Alamat</label>
                  <textarea class="form-control" name="alamat" rows="4" required=""  value="<?= $siswa["alamat"];  ?>"></textarea>
                </div>

                <div class="form-group">
                  <label>No Telpon</label>
                  <input type="text" name="no_telp" id="no_telp" required=""  value="<?= $siswa["no_telp"];  ?>" class="form-control">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="username" id="username" required="" value="<?= $siswa["username"]; ?>" class="form-control">
                </div>
                
                <div class="form-group">
                  <label>Password</label>
                  <input type="password" name="password" id="password" required="" 
                        value="<?= $siswa["password"]; ?>" class="form-control">
                </div>
