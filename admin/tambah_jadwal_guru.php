            ...
            <div id="content">
              ...
              <form action="" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="time" name="jam_awal" id="jam_awal" required="" class="form-control">
                </div>

                <div class="form-group">
                  <label>Jam Akhir</label>
                  <input type="time" name="jam_akhir" id="jam_akhir" required="" class="form-control">
                </div>
