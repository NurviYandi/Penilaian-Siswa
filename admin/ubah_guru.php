...
$guru = query_guru("SELECT guru.*, user.* FROM guru JOIN user ON guru.id_user = user.id_user 
    WHERE guru.id_user = $id_user") [0];
            ...
            <div id="content">
              ...
              <form action="" method="post">
                ...
                <div class="form-group">
                  <label>NIP</label>
                  <input type="text" name="nip" id="nip" required=""  value="<?= $guru["nip"];  ?>"  class="form-control">
                </div>

                <div class="form-group">
                  <label>Nama Guru</label>
                  <input type="text" name="nama_guru" id="nama_guru" required=""  value="<?= $guru["nama_guru"];  ?>" class="form-control">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="tanggal_lahir" id="tanggal_lahir" required=""  value="<?= $guru["tanggal_lahir"];  ?>" class="form-control">
                </div>

                <div class="form-group">
                  <label>Alamat</label>
                  <textarea class="form-control" name="alamat" rows="4" required=""  value="<?= $guru["alamat"];  ?>"></textarea>
                </div>

                <div class="form-group">
                  <label>No Telpon</label>
                  <input type="text" name="no_telp" id="no_telp" required=""  value="<?= $guru["no_telp"];  ?>" class="form-control">
                </div>
                
                <div class="form-group">
                  <label>Username</label>
                  <input type="text" name="username" id="username" required="" value="<?= $guru["username"]; ?>" class="form-control">
                </div>
                
                <div class="form-group">
                  <label>Password</label>
                  <input type="password" name="password" id="password" required="" 
                        value="<?= $guru["password"]; ?>" class="form-control">
                </div>
